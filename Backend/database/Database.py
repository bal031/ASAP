# This module is used for communicating with the asap_database.
# Use the get_database() method to open a connection and the 
# close_database() method to close it once finished.
